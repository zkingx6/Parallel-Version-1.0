  ...
  return (
    <main className="mx-auto max-w-2xl px-5 py-10 sm:px-8">
      ...
      <div className="rounded-xl border border-border/50 bg-card shadow-sm p-6">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Select a team from{" "}
          <Link href="/teams" className="text-primary hover:underline cursor-pointer">
            Your teams
          </Link>{" "}
        ...
        <button
          type="button"
          disabled
          className="mt-6 rounded-md bg-muted px-4 py-2 text-sm font-medium text-muted-foreground opacity-60 cursor-not-allowed"
        >
          Generate rotation
        </button>
      </div>
