      ...
      <div className="relative flex items-center justify-between h-16 pl-8 pr-8">
        ...
        <div className="shrink-0 flex items-center gap-3">
          ...
          {avatarLinksToAccount ? (
            <Link
              href={accountUrl}
              className="flex items-center justify-center rounded-full transition-opacity hover:opacity-80 focus:outline-none focus-visible:ring-2 focus-visible:ring-neutral-300 focus-visible:ring-offset-2 focus-visible:ring-offset-background"
              aria-label="Account"
            >
